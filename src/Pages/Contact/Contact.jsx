...
import SafeBankingFaq from "../../Components/Faq/SafeBankingFaq";
    ...
    <>
      <section class="text-gray-400 body-font relative">
        <div class="container px-5 py-24 mx-auto">
          ...
          <form
            action="https://formsubmit.co/allideas777@gmail.com"
            method="POST"
          >
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
              <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a class="text-blue-500">kawach@gmail.com</a>
                  <p class="leading-normal my-5">Indore</p>
